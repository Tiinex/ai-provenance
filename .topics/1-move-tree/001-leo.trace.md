...
- Continued From Parent: no
- Parent Trace: -
- Lineage: 001 (depth 1)
- Carry State: -
- Sender Adaptation Entries: 0
- Validation Issues: -
...
```json
{
  ...
  "snapshot": {
    ...
    "evidenceFile": {
      "status": "ready",
      "filePath": "c:\\Users\\micro\\Documents\\Repos\\Tiinex\\ai-provenance\\.topics\\1-move-tree\\001-leo.trace.md",
