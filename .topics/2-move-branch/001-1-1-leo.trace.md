...
- Parent Trace: 001-1-leo.trace.md
- User Input: hej igen
...
- Context In: Continuation parent: 001-1-leo.trace.md
Inherited carried context is present for this run.
- Inherited: Inherited from parent trace: 001-1-leo.trace.md
  ...
  "snapshot": {
    ...
    "requestSummary": [
      ...
      },
      {
        ...
        "title": "Continuation parent: 001-1-leo.trace.md\nInherited carried context is present for this run."
      },
      {
        "label": "Inherited",
        "value": "role · model · carry",
        "title": "Inherited from parent trace: 001-1-leo.trace.md\nRole: [leo.gpt-5-4-mini.experimental.agent.md](../../../ai/.github/agents/leo.gpt-5-4-mini.experimental.agent.md)\nModel: gpt-5.4-mini"
      }
    ],
    "statusHistory": [
      {
    ...
    "evidenceFile": {
      "status": "ready",
      "filePath": "c:\\Users\\micro\\Documents\\Repos\\Tiinex\\ai-provenance\\.topics\\1-move-tree\\001-1-1-leo.trace.md",
