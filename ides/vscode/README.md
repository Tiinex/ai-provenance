...
- native Explorer drag/drop and cut/paste moves of existing `.trace.md` artifacts across folders are also intentionally fail-closed on the current host surface; use `Move Trace...` instead of relying on folder-change rename hooks
