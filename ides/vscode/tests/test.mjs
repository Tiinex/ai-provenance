...
async function main() {
  ...
  assert.ok(panelSource.includes("interface PanelChatSenderRoleOption") && panelSource.includes("chatSenderRoleOptions?: ReadonlyArray<PanelChatSenderRoleOption>;"), "Traceable panel source is missing the sender-role render option.");
  ...
  assert.ok(panelSource.includes("chatSenderRole: ''"), "Traceable panel source is missing persisted sender-role state.");
