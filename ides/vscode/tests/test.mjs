...
async function main() {
  ...
  assert.ok(panelSource.includes("isNestedInteractiveTarget") && panelSource.includes("target.closest('[data-message], button, a, summary, input, select, textarea, label')") && !panelSource.includes("target.closest('[data-message], button, a, summary, details, input, select, textarea, label')"), "Traceable panel source should keep the nested-interaction guard without blocking request toggles inside Earlier Trace details groups.");
