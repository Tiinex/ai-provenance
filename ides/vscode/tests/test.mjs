...
async function main() {
  ...
  assert.ok(panelSource.includes('      ? "Please wait"'), "Traceable panel source is missing the shortened running hint for the chat composer.");
  ...
  assert.ok(panelSource.includes('return displayRole || "User";'), "Traceable panel source should label the primary prompt row with the direct parent role name and fall back to User.");
