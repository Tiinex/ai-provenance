...
async function main() {
  ...
  assert.ok(packageJson.contributes?.configuration?.properties?.["tiinex.aiProvenance.defaultNewTraceableChatExportTo"], "Default New Traceable Chat export-folder setting is missing.");
